                        ...
                        <div id="tab1">
                            {{ Form::open(array('url' => 'search','method' => 'GET')) }}
                                <ul class="propertyType-buttons">
                                    <li>
                                        <label for="anyPro">
                                            <input type="radio" id="anyPro" name="radio" checked>
                                            <span class="fake-label">All Types</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label for="home">
                                            <input type="radio" id="home" name="radio">
                                            <span class="fake-label">Homes</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label for="plots">
                                            <input type="radio" id="plots" name="radio">
                                            <span class="fake-label">Plots</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label for="commerical">
                                            <input type="radio" id="commerical" name="radio">
