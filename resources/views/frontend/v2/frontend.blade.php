            ...
            <div class="top-bar">
                ...
                <div class="right-sideTop text-right">
                    ...
                    <ul class="loginRegister text-upparcase text-left">
                        ...
                        <li><a href="#">List your property<span class="icon-arrow-with-circle-right"></span></a></li>
                    </ul>
                </div>
            </div>
            <div class="logo"><a href="#"><img src="{{url('/')}}/web-apps/frontend/v2/images/logo.png" width="477" height="150" alt="Property42"></a></div>
        </header>
        @yield('content')
    <footer id="footer">
