            ...
            <div class="listing-page">
                <div class="container">
                    ...
                    <aside id="aside" class="hideOnMobile">
                        <form class="filter-form" id="properties-filter-form" method="get"
                              action="<?= url('/search') ?>">
                            <ul class="filters-links text-upparcase">
                                        ...
                                        <div class="fromTo">
                                            <div class="field-holder">
                                                <input type="number" placeholder="From" name="land_area_from"
                                                       value="{{$response['data']['oldValues']['landAreaFrom']}}">
                                            </div>
                                            <div class="field-holder">
                                                <input type="number" placeholder="To" name="land_area_to"
                                                       value="{{$response['data']['oldValues']['landAreaTo']}}">
                                            </div>
                                ...
                                <li class="active">
                                    ...
                                    <div class="slide">
                                        <div class="fromTo">
                                            <div class="field-holder">
                                                <input type="number" placeholder="From" name="price_from"
                                                       value="{{$response['data']['oldValues']['priceFrom']}}"
                                                       class="priceInputFrom PriceField">
                                            </div>
                                            <div class="field-holder">
                                                <input type="number" placeholder="To" name="price_to"
                                                       value="{{$response['data']['oldValues']['priceTo']}}"
                                                       class="priceInputTo PriceField">
                                            </div>
                                            <button type="submit">Go</button>
                                        </div>
                                        ...
                                        <ul class="filterChecks">
                                            <li>
                                                <label for="buy-filter" class="customRadio">
                                                    <input type="radio" name="purpose_id" id="buy-filter"
                                                           class="filter-form-input" value="1"
                                                           @if($response['data']['oldValues']['purposeId'] == 1) checked @endif>
                                            ...
                                            <li>
                                                <label for="rent-filter" class="customRadio">
                                                    <input type="radio" name="purpose_id" id="rent-filter"
                                                           class="filter-form-input" value="2"
                                                           @if($response['data']['oldValues']['purposeId'] == 2) checked @endif>
                                                    <span class="fake-checkbox"></span>
                                            ...
                                            <li>
                                                <label for="all-types" class="customRadio">
                                                    <input type="radio" id="all-types"
                                                           @if($response['data']['oldValues']['propertyTypeId'] == "") checked
                                                           @endif
                                                           name="property_type_id"
                                                           class="property_type filter-form-input" value="">
                                                    <span class="fake-checkbox"></span>
                                            ...
                                            @foreach($response['data']['propertyTypes'] as $propertyType)
                                                <li>
                                                    <label for="{{$propertyType->name."_".$propertyType->id}}"
                                                           class="customRadio">
                                                        <input type="radio"
                                                               id="{{$propertyType->name."_".$propertyType->id}}"
                                                               @if($response['data']['oldValues']['propertyTypeId'] == $propertyType->id)checked
                                                               @endif
                                                               name="property_type_id"
                                                               class="property_type filter-form-input"
                                    ...
                                    <div class="slide">
                                        <ul class="filterChecks">
                                            <li>
                                                <label for="all-sub-types" class="customRadio">
                                                    <input type="radio" id="all-sub-types"
                                                           @if($response['data']['oldValues']['subTypeId'] == "") checked
                                                           @endif
                                                           name="sub_type_id"
                                                           class="property_sub_type filter-form-input" value="">
                                                    <span class="fake-checkbox"></span>
                                            ...
                                            @foreach($response['data']['propertySubtypes'] as $propertySubType)
                                                <li>
                                                    <label for="{{$propertySubType->name."_".$propertySubType->id}}"
                                                           class="customRadio">
                                                        <input type="radio"
                                                               id="{{$propertySubType->name."_".$propertySubType->id}}"
                                                               @if($response['data']['oldValues']['subTypeId'] == $propertySubType->id) checked
                                                               @endif
                                                               name="sub_type_id"
                                                               class="property_sub_type filter-form-input"
                                ...
                                <li class="active">
                                    ...
                                    <div class="slide">
                                        <ul class="filterChecks">
                                            <li>
                                                <select class="js-example-basic-single filter-form-input"
                                                        name="society_id">
                                                    <option value="">All Societies</option>
                                                    @foreach($response['data']['societies'] as $society)
                                                        <option value="{{$society->id}}"
                                                                @if($response['data']['oldValues']['societyId'] == $society->id) selected @endif>{{$society->name}}</option>
                                                    @endforeach
                                                </select>
                                            </li>
                                            <li>
                                                <select class="js-example-basic-single filter-form-input "
                                                        @if(sizeof($response['data']['blocks']) == 0) disabled
                                                        @endif name="block_id">
                                                    <option value="">All Blocks</option>
                                                    @foreach($response['data']['blocks'] as $block)
                                                        <option value="{{$block->id}}"
                                                                @if($response['data']['oldValues']['blockId'] == $block->id) selected @endif>{{$block->name}}</option>
                                                    @endforeach
                                                </select>
                                            </li>
                                        </ul>
                        ...
                        @foreach($response['data']['properties'] as $property)
                            ...
                            <article class="publicProperty-post">
                                <div class="image-holder">
                                    <a href="property?propertyId={{$property->id}}"><img src="{{$image}}"
                                ...
                                <div class="caption text-left">
                                    <div class="layout">
                                        <div class="left-area">
                                            <h1>
                                                <a href="property?propertyId={{$property->id}}">{{ ''.$property->land->area.' '.$property->land->unit->name .' '}}{{$property->type->subType->name.'
                                             '.$property->purpose->name.' in '.$property->location->block->name.' Block'.
                                             ' '.$property->location->society->name}}</a></h1>

                                            <p>{{str_limit($property->title,50) }}
                                                <br/>{{str_limit($property->description,100) }}</p>
                                        </div>
                                        <div class="right-area">
                                            <strong class="price"><span>Rs</span> {{App\Libs\Helpers\PriceHelper::numberToRupees($property->price)}}
                                            </strong>
                                    ...
                                    <div class="layout">
                                        <div class="links-left">
                                            <a href="property?propertyId={{$property->id}}"
                                               class="btn-default text-upparcase">VIEW DETAILS <span
                                                        class="icon-Vector-Smart-Object"></span></a>
                                            @if(isset($property->isVerified) && $property->isVerified == 1)
                                                <span class="trusted-agent"><span class="icon-trusted"><span
                                                                ...
                                                                class="path7"></span><span class="path8"></span></span>Verified</span>
                                            @endif
                                        </div>
                                        <div class="links-right">
                                            <ul class="quick-links">
                                                <li><a href="#callPopup" class="lightbox call-agent-btn"
                                                       data-tel="{{$property->phone}}"><span class="icon-phone"></span></a>
                                                </li>
                                            ...
                                            ?>
                                            <a href="{{ URL::to('agent?agent_id='.$property->owner->id) }}"> <img
                    ...
                    <ul class="pager">
                        @if($totalPaginationValue !=0)
                            <li><a href="{{$previousResult}}" class="previous"><span
                                            class="icon-chevron-thin-left"></span></a></li>
                        @endif
                        <?php
                        ...
                        <?php }?>
                        @if($totalPaginationValue !=0)
                            <li><a href="{{$nextResult}}" class="next"><span class="icon-chevron-thin-right"></span></a>
                            </li>
                        @endif
                    </ul>
