...
class GetBlockBySocietyRequest extends Request implements RequestInterface
{
    public $validator = null;
    public function __construct(){
        parent::__construct(new GetBlockBySocietyTransformer($this->getOriginalRequest()));
        $this->validator = new GetBlockBySocietyValidator($this);
    }
